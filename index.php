    ...
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          ...
          <a href="index.php?page=product&action=add&id=24" class="btn"><span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
